    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _app_rounting_module__WEBPACK_IMPORTED_MODULE_7__["AppRountingModule"]
            ],
            providers: [],
...
module.exports = "<h3>Top Heroes</h3>\n<br>\n<div class=\"grid grid-pad\">\n\t<a *ngFor=\"let hero of heroes\" class=\"col-md-3\" routerLink=\"/detail/{{hero.id}}\">\n\t<div class=\"module hero\">\n\t\t<h4>{{hero.name}}</h4>\n\t</div>\n\t</a>\n</div>\n<br>"
...
module.exports = "<div *ngIf=\"messageService.messages.length\">\n\n\t<h2>Messages</h2>\n\t<button class=\"btn btn-primary\" (click)=\"messageService.clear()\">Clear</button>\n\n\t<div *ngFor = \"let message of messageService.Messages\">{{message}}</div>\n\n</div>\n\n"
...
module.exports = __webpack_require__(/*! F:\Angular-Workspace\tour-of-heros\src\main.ts */"./src/main.ts");
